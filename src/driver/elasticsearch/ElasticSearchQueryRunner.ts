...
import { ElasticSearchEntityManager } from "../../entity-manager/ElasticSearchEntityManager";
 ...
 */
export class ElasticSearchQueryRunner implements QueryRunner {
   ...
   */
  manager: ElasticSearchEntityManager;
   ...
   */
  databaseConnection: ElasticSearch.Client;

  // -------------------------------------------------------------------------
  // Constructor
  // -------------------------------------------------------------------------

  constructor(connection: Connection, databaseConnection: ElasticSearch.Client) {
