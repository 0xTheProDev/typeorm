...
import { ElasticSearchQueryRunner } from "../driver/elasticsearch/ElasticSearchQueryRunner";
import { ElasticSearchDriver } from "../driver/elasticsearch/ElasticSearchDriver";
 ...
 *
 * This implementation is used for ElasticSearch driver which has some specifics in its EntityManager.
 */
export class ElasticSearchEntityManager extends EntityManager {
   ...
   */
  // @ts-ignore
  get queryRunner(): ElasticSearchQueryRunner {
    return (this.connection.driver as ElasticSearchDriver).queryRunner!;
  }
